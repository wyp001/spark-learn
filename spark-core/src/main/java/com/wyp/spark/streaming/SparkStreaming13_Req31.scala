...
object SparkStreaming13_Req31 {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val kafkaDataDS: InputDStream[ConsumerRecord[String, String]] = KafkaUtils.createDirectStream[String, String](
            ...
            ConsumerStrategies.Subscribe[String, String](Set("spark-learn-topic"), kafkaPara)
        )
        ...
        reduceDS.foreachRDD(
            rdd => {
                ...
                // 输出文件
                val out = new PrintWriter(new FileWriter(new File("E:\\workspace\\learn\\spark-learn\\spark-core\\static\\adclick\\adclick.json")))
