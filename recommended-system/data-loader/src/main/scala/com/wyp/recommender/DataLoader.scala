...
object DataLoader {
  ...
  // 定义数据文件路径
  val PRODUCT_DATA_PATH = "E:\\workspace\\learn\\spark-learn\\recommended-system\\data-loader\\src\\main\\resources\\products.csv"
  val RATING_DATA_PATH = "E:\\workspace\\learn\\spark-learn\\recommended-system\\data-loader\\src\\main\\resources\\ratings.csv"
  // 定义mongodb中存储的表名
  ...
  def main(args: Array[String]): Unit = {
    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://192.168.6.180:27017/recommender",
